...
Одной из последний версий YOLO является [YOLOv3](https://pjreddie.com/media/files/papers/YOLOv3.pdf). В ней авторы отказались от *fully-connected* слоя в конце, таким образом остались только свёрточные слои. Было добавлено 2 дополнительных выходных слоя для улучшения распознавания объектов разных размеров.
